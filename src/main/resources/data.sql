...
VALUES ("João Contratante", "123.456.789-00", "1990-01-15", "MASCULINO"),
       ...
       ("Daniel Contratante", "064.789.360-66", "1992-09-30", "MASCULINO");
...
INSERT INTO endereco (rua, numero, bairro, cidade, estado, cep, contratante_id, residente_id)
VALUES ("Rua A", 123, "Centro", "Cidade A", "SP", "12345-678", 1, 1),
       ("Rua B", 456, "Bairro X", "Cidade B", "RJ", "56789-012", 2, 2),
       ("Rua C", 789, "Bairro Y", "Cidade C", "MG", "23456-789", 3, 3),
       ("Rua D", 101, "Bairro Z", "Cidade D", "RS", "34567-890", 4, 4),
       ("Rua E", 202, "Bairro W", "Cidade E", "SC", "45678-901", 5, 5);
       
       
INSERT INTO endereco (rua, numero, bairro, cidade, estado, cep, contratante_id)
VALUES ("Rua F", 203, "Bairro G", "Cidade T", "SC", "45678-901", 6);
...
VALUES ("Geladeira", "ABC123", 150, "V220", 1),
       ...
       ("Computador Melhor", "Mac", 500, "V110", 6);
